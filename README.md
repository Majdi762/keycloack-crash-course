...
1. Clone the repository:
    ```bash
    git clone git@github.com:Majdi762/keycloack-crash-course.git
    ```
...
3. Create a new Real and name  or update the ```application.yml``` file and specify your Realm name
4. Create Roles
5. Create Users
